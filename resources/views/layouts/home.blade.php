    ...
    <div class="home-container pt-4">
        <nav class="card-nav">
            <ul>
                ...
                <li id="to-rules-button" class="text-truncate @if(Route::currentRouteName() == 'rules' || Route::currentRouteName() == 'sets') active @endif">Kelola Perhitungan</li>
                <li id="to-logout-button" class="text-truncate">Logout</li>
